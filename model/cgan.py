...
class CGan():
    def __init__(self, num_classes, batch_size=64, img_channels=3, img_size=128, noise_dim=10, embed_size=5):
    ...
    def G(self, labels):
        ...
        embedding = self.generator_embedding(labels)
    ...
    def D(self, input_images, labels):
        ...
        embedding = self.discriminator_embedding(labels)
